...
def make_clean_params(q: float, gamma: float, q_bar: int = 50, fixed_psi: Optional[float] = None, Nt_for_recalib: int = 1000) -> CleanParams:
    p = CleanParams(qconst=float(q), gamma=float(gamma), q_bar=int(q_bar))
